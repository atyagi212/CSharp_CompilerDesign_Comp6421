                ...
                foreach (FileInfo file in arrFiles)
                {
                    ...
                    if (fileExt == ".outlextokens")
                    {
                        ...
                        try
                        {
                            ...
                            foreach (var item in Common.semanticErrors)
                            {
                                File.AppendAllText(Path.Combine(@"/Users/akshattyagi/Downloads/LexDriver/LexDriver/OutputFiles", Path.GetFileNameWithoutExtension(filename) + ".outsemanticerrors"), item + "\n");
                            }
                        }
                        catch (IOException e)
                        {
